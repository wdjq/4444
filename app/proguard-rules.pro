...
# 实体类
-keep class com.github.tvbox.Mobilewdjq.bean.** { *; }

#CardView
-keep class com.github.tvbox.Mobilewdjq.ui.tv.widget.card.**{*;}
#ViewObj
-keep class com.github.tvbox.Mobilewdjq.ui.tv.widget.ViewObj{
    <methods>;
}
